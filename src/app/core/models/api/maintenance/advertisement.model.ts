...
export class Advertisement extends Model {
  ...
  public static cast(data: object): Advertisement {
    ...
    const { id, titulo, descripcion, tipo, imagen, is_active, order } = advertisement;
    return { id, titulo, descripcion, tipo, imagen, is_active, order };
  }
...
export class AdvertisementList extends Model {
  ...
  public static cast(data: object): AdvertisementList {
    ...
    const { id, titulo, descripcion, tipo, tipo_text, imagen, is_active, user_create_id, user_update_id, user_delete_id, created_at, updated_at, deleted_at, order } = advertisementList;
    return { id, titulo, descripcion, tipo, tipo_text, imagen, is_active, user_create_id, user_update_id, user_delete_id, created_at, updated_at, deleted_at, order };
  }
