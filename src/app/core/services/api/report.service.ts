...
export class ReportService {
  ...
  private get baseUrl() {
    return this.configService.apiUrl + 'report';
  }
  ...
  public salesByBrand(data: any): Observable<ResponseApi> {
    const endpoint = `${this.baseUrl}/sales-brand`;
    return this.http.post(endpoint, data, this.requestOptions).pipe(map((res: ResponseApi) => res))
  }

  public salesBySeller(data: any): Observable<ResponseApi> {
    const endpoint = `${this.baseUrl}/sales-seller`;
    return this.http.post(endpoint, data, this.requestOptions).pipe(map((res: ResponseApi) => res))
  }

  public salesByCoordinator(data: any): Observable<ResponseApi> {
    const endpoint = `${this.baseUrl}/sales-coordinator`;
    return this.http.post(endpoint, data, this.requestOptions).pipe(map((res: ResponseApi) => res))
  }
